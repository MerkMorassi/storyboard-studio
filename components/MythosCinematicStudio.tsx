    ...
    return (
        <div className="p-6 max-w-7xl mx-auto w-full h-full flex flex-col space-y-6 overflow-y-auto">
            <div className="flex-shrink-0 flex items-center justify-between">
                <div>
                    <h2 className="text-3xl font-bold text-neutral-200 mb-2">Engine: MythOS Cinematic Core <span className="text-lg font-normal text-blue-500">v4.2 (Direct Hardware)</span></h2>
