...
import { DownloadIcon, StoryboardIcon } from './icons.tsx';
...
const StoryboardFrame: React.FC<{
    ...
    return (
        <div
            ...
            className={`flex-shrink-0 w-72 bg-neutral-900 shadow-lg border border-neutral-800 transition-all duration-300 rounded-lg overflow-hidden ${isBeingDraggedOver ? 'transform scale-105 bg-neutral-800' : ''}`}
        >
            <div className="relative group">
                ...
                <div className="absolute top-2 right-2 flex flex-col gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                    <button
                        ...
                        className="bg-black/50 text-white p-1.5 hover:bg-neutral-700 transition-colors rounded"
            ...
            <div className="p-3 space-y-2">
                <textarea
                    ...
                    className="w-full h-24 bg-neutral-800/50 text-sm text-neutral-300 border border-neutral-700 p-2 resize-y focus:ring-2 focus:ring-neutral-500 outline-none rounded"
                />
            </div>
        </div>
    );
    ...
    return (
        <div className="p-6 max-w-7xl mx-auto w-full">
            <div className="mb-8">
                ...
                <p className="text-neutral-400">Arrange and annotate your generated images to build your narrative sequence.</p>
            </div>
            ...
            {frames.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-[50vh] border-2 border-dashed border-neutral-800 rounded-xl bg-neutral-900/30 text-center p-8">
                    ...
                    <h3 className="text-xl font-semibold text-neutral-300 mb-2">Your Storyboard is Empty</h3>
                    <p className="text-neutral-500">Go to the Grid View and add images to start building your story.</p>
                </div>
            ) : (
                <div 
